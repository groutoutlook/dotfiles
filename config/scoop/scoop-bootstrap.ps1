...
scoop alias add 'h' 'foreach ($_ in $args) {scoop hold $_}' 'remove a list of things.'
scoop alias add 'i' 'foreach ($_ in $args) {scoop install $_}' 'Install apps'
scoop alias add 'ls' 'scoop list' 'List installed apps'
scoop alias add 'remove' 'scoop uninstall $args[0]' 'Uninstall an app'
scoop alias add 'rm' 'foreach ($_ in $args) {scoop uninstall $_}' 'remove a list of things.'
...
scoop alias add 'uh' 'foreach ($_ in $args) {scoop unhold $_}' 'remove a list of things.'
